---
layout: page
permalink: /publications/education
title: publications
...
<ul class="nav nav-pills mb-4">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="{{ '/publications_education/' | relative_url }}">Education</a>
  </li>
  <li class="nav-item">
...
<div class="publications">
 {% bibliography --query @*[topic=education] --group_by type %}
</div>
